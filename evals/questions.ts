...
export const evaluationQuestions: { input: Message[]; expected: string }[] = [
  {
    ...
    expected: "The Four Horsemen are Criticism, Defensiveness, Contempt, and Stonewalling. According to the Gottmans' research, Contempt is the single best predictor of relationship breakup.",
  },
  {
    input: [
      {
